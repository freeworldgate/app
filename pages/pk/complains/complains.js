...
Page({
  ...
  queryComments:function(tab,pkId)
  {
    ...
    httpClient.send(request.url.complainList, "GET", {pkId:pkId});
  },
  ...
  onReachBottom:function()
  {
      ...
      httpClient.addHandler("success", function (nextPages) {
        that.setData({
            ...
            complains:that.data.complains.concat(nextPages)
        })
      })
      httpClient.send(request.url.morecomplainList, "GET",{ pkId:that.data.pkId,page:that.data.page});
