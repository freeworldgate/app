...
Page({
  ...
  onLoad: function (options) {
    ...
    httpClient.send(request.url.queryApprovedPost, "GET",{pkId: that.data.pkId,type:1});
  ...
  onReachBottom:function () {
    var that = this;
      ...
      httpClient.send(request.url.queryMoreApprovedPost, "GET",{pkId: that.data.pkId,page:that.data.page, type:1});
