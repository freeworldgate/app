...
Page({
  ...
  queryPks:function (tab) {
    ...
    httpClient.send(request.url.queryPkCreators, "GET", {type:1});
  },
  onShow:function(){
    var that = this;
  ...
  onReachBottom: function () {
    var that = this;
      ...
      httpClient.send(request.url.morePkCreators, "GET",{ userId:user.userId ,page:that.data.page,type:1});
    
  },
  switchBit:function(res){
    var that = this;
    ...
    httpClient.send(request.url.switchBit, "GET",{pkId:pkid});
  },
